...
typedef struct coordinate_reader_s {
   /** Opaque pointer to the data structure used by the specific implementaiton
    *of coordinate_reader.*/
   void *internals;

   /** The total number of records available from this coordinate reader.*/
   unsigned int num_records;

   /** The projector which this coordinate reader should use to project
    *spherical coordinates into X/Y space.*/
   ...
   /**
     * Read a single set of values from this coordinate reader. Implementors
     *should use the projector instance to project
     * spherical coordinates into the correct projection before storing the
     *coordinates.
     *
