...
typedef struct grid_s {
   ...
   /**
     ...
     *
     * For a horizontal position x, the horizontal sampling range is {x -
     *horizontal_sampling_offset, x + horizontal_sampling_offset}
     */
   ...
   /**
     ...
     *
     * For a vertical position y, the vertical sampling range is {y -
     *vertical_sampling_offset, y + vertical_sampling_offset}
     */
   ...
   /** An initialised projector which transforms spherical coordinates to this
    *grid. */
...
grid *initialise_grid(int width, int height, float vertical_resolution,
                      float horizontal_resolution, float vsample, float hsample,
                      float central_x,
                      float central_y,
                      projector *input_projector);
