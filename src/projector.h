...
/**
 * Represent a set of projected coordinates (in the X/Y space, typically in units of metres).
 */
typedef struct {
   /** The Y value */
   float y;
...
/**
 * Represent a set of spherical coordinates (in the latitude/longitude space, typically in units of degrees).
 */
typedef struct {
   /** The longitude value */
   float longitude;
